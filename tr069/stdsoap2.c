...
static int soap_ssl_get_session(ssl_context *ssl);
static int soap_ssl_set_session(ssl_context *ssl);
...
char *dummy_dhm_G = "4"; /* dummy DHM pairs - PolarSSL crashes if I don't provide them */
...
#elif defined(WITH_AXTLS)

static const struct soap_code_map h_ssl_error_codes[] =
{
  _SSL_ERROR(SSL_NOT_OK),		/* some constants are missing, too (X509) ... */
  _SSL_ERROR(SSL_ERROR_DEAD),
  _SSL_ERROR(SSL_ERROR_CONN_LOST),
  _SSL_ERROR(SSL_ERROR_SOCK_SETUP_FAILURE),
  _SSL_ERROR(SSL_ERROR_INVALID_HANDSHAKE),
  _SSL_ERROR(SSL_ERROR_INVALID_PROT_MSG),
  _SSL_ERROR(SSL_ERROR_INVALID_HMAC),
  _SSL_ERROR(SSL_ERROR_INVALID_VERSION),
  _SSL_ERROR(SSL_ERROR_INVALID_SESSION),
  _SSL_ERROR(SSL_ERROR_NO_CIPHER),
  _SSL_ERROR(SSL_ERROR_BAD_CERTIFICATE),
  _SSL_ERROR(SSL_ERROR_INVALID_KEY),
  _SSL_ERROR(SSL_ERROR_FINISHED_INVALID),
  _SSL_ERROR(SSL_ERROR_NO_CERT_DEFINED),
  _SSL_ERROR(SSL_ERROR_NOT_SUPPORTED),
  _SSL_ERROR(SSL_X509_OFFSET),
  { 0, NULL }
};
...
static const struct soap_code_map h_ssl_error_codes[] =
{
  _SSL_ERROR(POLARSSL_ERR_BASE64_BUFFER_TOO_SMALL),
  _SSL_ERROR(POLARSSL_ERR_BASE64_INVALID_CHARACTER),
  _SSL_ERROR(POLARSSL_ERR_MPI_FILE_IO_ERROR),
  _SSL_ERROR(POLARSSL_ERR_MPI_BAD_INPUT_DATA),
  _SSL_ERROR(POLARSSL_ERR_MPI_INVALID_CHARACTER),
  _SSL_ERROR(POLARSSL_ERR_MPI_BUFFER_TOO_SMALL),
  _SSL_ERROR(POLARSSL_ERR_MPI_NEGATIVE_VALUE),
  _SSL_ERROR(POLARSSL_ERR_MPI_DIVISION_BY_ZERO),
  _SSL_ERROR(POLARSSL_ERR_MPI_NOT_ACCEPTABLE),
  _SSL_ERROR(POLARSSL_ERR_DHM_BAD_INPUT_DATA),
  _SSL_ERROR(POLARSSL_ERR_DHM_READ_PARAMS_FAILED),
  _SSL_ERROR(POLARSSL_ERR_DHM_MAKE_PARAMS_FAILED),
  _SSL_ERROR(POLARSSL_ERR_DHM_READ_PUBLIC_FAILED),
  _SSL_ERROR(POLARSSL_ERR_DHM_MAKE_PUBLIC_FAILED),
  _SSL_ERROR(POLARSSL_ERR_DHM_CALC_SECRET_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_UNKNOWN_HOST),
  _SSL_ERROR(POLARSSL_ERR_NET_SOCKET_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_CONNECT_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_BIND_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_LISTEN_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_ACCEPT_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_RECV_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_SEND_FAILED),
  _SSL_ERROR(POLARSSL_ERR_NET_CONN_RESET),
  _SSL_ERROR(POLARSSL_ERR_NET_TRY_AGAIN),
  _SSL_ERROR(POLARSSL_ERR_RSA_BAD_INPUT_DATA),
  _SSL_ERROR(POLARSSL_ERR_RSA_INVALID_PADDING),
  _SSL_ERROR(POLARSSL_ERR_RSA_KEY_GEN_FAILED),
  _SSL_ERROR(POLARSSL_ERR_RSA_KEY_CHECK_FAILED),
  _SSL_ERROR(POLARSSL_ERR_RSA_PUBLIC_FAILED),
  _SSL_ERROR(POLARSSL_ERR_RSA_PRIVATE_FAILED),
  _SSL_ERROR(POLARSSL_ERR_RSA_VERIFY_FAILED),
  _SSL_ERROR(POLARSSL_ERR_SSL_FEATURE_UNAVAILABLE),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_INPUT_DATA),
  _SSL_ERROR(POLARSSL_ERR_SSL_INVALID_MAC),
  _SSL_ERROR(POLARSSL_ERR_SSL_INVALID_RECORD),
  _SSL_ERROR(POLARSSL_ERR_SSL_INVALID_MODULUS_SIZE),
  _SSL_ERROR(POLARSSL_ERR_SSL_UNKNOWN_CIPHER),
  _SSL_ERROR(POLARSSL_ERR_SSL_NO_CIPHER_CHOSEN),
  _SSL_ERROR(POLARSSL_ERR_SSL_NO_SESSION_FOUND),
  _SSL_ERROR(POLARSSL_ERR_SSL_NO_CLIENT_CERTIFICATE),
  _SSL_ERROR(POLARSSL_ERR_SSL_CERTIFICATE_TOO_LARGE),
  _SSL_ERROR(POLARSSL_ERR_SSL_CERTIFICATE_REQUIRED),
  _SSL_ERROR(POLARSSL_ERR_SSL_PRIVATE_KEY_REQUIRED),
  _SSL_ERROR(POLARSSL_ERR_SSL_CA_CHAIN_REQUIRED),
  _SSL_ERROR(POLARSSL_ERR_SSL_UNEXPECTED_MESSAGE),
  _SSL_ERROR(POLARSSL_ERR_SSL_FATAL_ALERT_MESSAGE),
  _SSL_ERROR(POLARSSL_ERR_SSL_PEER_VERIFY_FAILED),
  _SSL_ERROR(POLARSSL_ERR_SSL_PEER_CLOSE_NOTIFY),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CLIENT_HELLO),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_SERVER_HELLO),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CERTIFICATE),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CERTIFICATE_REQUEST),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_SERVER_KEY_EXCHANGE),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_SERVER_HELLO_DONE),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CLIENT_KEY_EXCHANGE),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CERTIFICATE_VERIFY),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_CHANGE_CIPHER_SPEC),
  _SSL_ERROR(POLARSSL_ERR_SSL_BAD_HS_FINISHED),
  _SSL_ERROR(POLARSSL_ERR_ASN1_OUT_OF_DATA),
  _SSL_ERROR(POLARSSL_ERR_ASN1_UNEXPECTED_TAG),
  _SSL_ERROR(POLARSSL_ERR_ASN1_INVALID_LENGTH),
  _SSL_ERROR(POLARSSL_ERR_ASN1_LENGTH_MISMATCH),
  _SSL_ERROR(POLARSSL_ERR_ASN1_INVALID_DATA),
  _SSL_ERROR(POLARSSL_ERR_X509_FEATURE_UNAVAILABLE),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_PEM),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_FORMAT),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_VERSION),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_SERIAL),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_ALG),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_NAME),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_DATE),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_PUBKEY),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_SIGNATURE),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_INVALID_EXTENSIONS),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_UNKNOWN_VERSION),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_UNKNOWN_SIG_ALG),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_UNKNOWN_PK_ALG),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_SIG_MISMATCH),
  _SSL_ERROR(POLARSSL_ERR_X509_CERT_VERIFY_FAILED),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_INVALID_PEM),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_INVALID_VERSION),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_INVALID_FORMAT),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_INVALID_ENC_IV),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_UNKNOWN_ENC_ALG),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_PASSWORD_REQUIRED),
  _SSL_ERROR(POLARSSL_ERR_X509_KEY_PASSWORD_MISMATCH),
  _SSL_ERROR(POLARSSL_ERR_X509_POINT_ERROR),
  _SSL_ERROR(POLARSSL_ERR_X509_VALUE_TO_LENGTH),
  { 0, NULL }
};
#endif
...
static void fset_nonblock(SOAP_SOCKET fd)
{
#if defined(WIN32)
...
static void fset_block(SOAP_SOCKET fd)
{
#if defined(WIN32)
  u_long blocking = 0;
  ...
  { if (soap_valid_socket(soap->socket))
    {
	  ...
	  if (soap->ssl && soap->omode & SOAP_ENC_SSL)
...
#elif defined(WITH_AXTLS)
      if (soap->ssl)
        nwritten = ssl_write(soap->ssl, (const uint8_t*) s, n);
      else
#elif defined(WITH_POLARSSL)
      if ((soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL) && soap->omode & SOAP_ENC_SSL)
        nwritten = ssl_write(&soap->ssl, (unsigned char*) s, n);
      else
#endif
#ifdef WITH_UDP
      ...
      { register int r = 0;
        ...
        if (soap->ssl && (r = SSL_get_error(soap->ssl, nwritten)) != SSL_ERROR_NONE && r != SSL_ERROR_WANT_READ && r != SSL_ERROR_WANT_WRITE)
          return SOAP_EOF;
#elif defined(WITH_AXTLS)
        if (soap->ssl && nwritten < SSL_OK)
          return SOAP_EOF;
#elif defined(WITH_POLARSSL)
        if (nwritten && nwritten != POLARSSL_ERR_NET_TRY_AGAIN)
	  return SOAP_EOF;
#endif
        err = soap_socket_errno(soap->socket);
  ...
  { for (;;)
    {
      ...
      { struct timeval timeout;
        ...
        {
/*
 * polarssl handshake has been complete at this point and
 * ssL_read WILL not do any writes, so use the plain read test only
 */
#if defined(WITH_SSL) && !defined(WITH_POLARSSL)
	  if (soap->ssl && soap->imode & SOAP_ENC_SSL)
            r = select((SOAP_SOCKET)(soap->socket + 1), &fd, &fd, &fd, &timeout);
          else
            r = select((SOAP_SOCKET)(soap->socket + 1), &fd, NULL, &fd, &timeout);
#else
...
#elif defined(WITH_AXTLS)
      fset_block(soap->socket);
      if (soap->ssl)
      { uint8_t *read_buf;
        while ((r = ssl_read(soap->ssl, &read_buf)) == SSL_OK);
        if (r > SSL_OK)
        { memcpy(s, read_buf, r > n ? n : r);
          return (size_t)r;
        }
        else
          return 0;
...
#elif defined(WITH_POLARSSL)
      fset_nonblock(soap->socket);
      if ((soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL) && soap->imode & SOAP_ENC_SSL)
      {	      r = ssl_read(&soap->ssl, (unsigned char*) s, n);

	if (r > 0)
          return (size_t)r;
	if (r != POLARSSL_ERR_NET_TRY_AGAIN)
	  return 0;
      }
      else
#endif
...
#endif
#ifndef WITH_NOHTTP /* TODO: Chunked reading proably won't work with axTLS, yet */
...
int
SOAP_FMAC2
soap_ssl_server_context(struct soap *soap, unsigned short flags, const char *crtfile, const char *keyfile, const char *password, const char *cafile, const char *capath, const char *dhfile, const char *randfile, const void *sid)
{ soap->crtfile = crtfile;
  ...
  if (!dhfile)
    soap->ssl_flags |= SOAP_SSL_RSA;
#ifdef WITH_OPENSSL
  { int err;
    if (!(err = soap->fsslauth(soap)) && sid)
      SSL_CTX_set_session_id_context(soap->ctx, (const unsigned char*)sid, strlen((const char*)sid));
    return err;
  }
#elif defined(WITH_POLARSSL)
  if (sid)
    soap->polarssl_flags |= SOAP_SSL_POLARSSL_USE_RESUMING;
#else
  soap->session = sid;
#endif
...
int
SOAP_FMAC2
soap_ssl_client_context(struct soap *soap, unsigned short flags, const char *crtfile, const char *keyfile, const char *password, const char *cafile, const char *capath, const char *randfile)
{ soap->crtfile = crtfile;
  soap->keyfile = keyfile;
  soap->password = password;
  soap->cafile = cafile;
...
SOAP_FMAC2
soap_ssl_error(struct soap *soap, int ret)
{ const char *msg = soap_code_str(h_ssl_error_codes, ret);
  if (msg)
    strcpy(soap->msgbuf, msg);
  else
    sprintf(soap->msgbuf, "SSL (axTLS): Unknown error code %d", ret);
  return soap->msgbuf;
}
...
{ const char *msg = soap_code_str(h_ssl_error_codes, ret);
  if (msg)
    ...
    sprintf(soap->msgbuf, "SSL (PolarSSL): Unknown error code %d", ret);
  return soap->msgbuf;
}
...
{ int r;
  ...
  { uint32_t options = SSL_SERVER_VERIFY_LATER | SSL_NO_DEFAULT_KEY |
	  		(soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION ? SSL_CLIENT_AUTHENTICATION : 0)
                        /* add these for debugging: | SSL_DISPLAY_BYTES | SSL_DISPLAY_STATES | SSL_DISPLAY_CERTS | SSL_DISPLAY_RSA */ ;
    if (!(soap->ctx = ssl_ctx_new(options, SSL_DEFAULT_SVR_SESS)))
      return soap_set_receiver_error(soap, "SSL error", "Can't setup context", SOAP_SSL_ERROR);
  }

  if (soap->keyfile)
  { int obj_type;
    if (strstr(soap->keyfile, ".p8"))
      obj_type = SSL_OBJ_PKCS8;
    else if (strstr(soap->keyfile, ".p12"))
      obj_type = SSL_OBJ_PKCS12;
    else if (soap->ssl_flags & SOAP_SSL_RSA)
      obj_type = SSL_OBJ_RSA_KEY;
    else
      return soap_set_receiver_error(soap, "SSL error", "Can't resolve key type", SOAP_SSL_ERROR);

    if ((r = ssl_obj_load(soap->ctx, obj_type, soap->keyfile, soap->password)) != SSL_OK)
      return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read key file", SOAP_SSL_ERROR);
  }

  if (soap->cafile)
  { if ((r = ssl_obj_load(soap->ctx, SSL_OBJ_X509_CACERT, soap->cafile, NULL)) != SSL_OK)
      return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file", SOAP_SSL_ERROR);
  }
  else if(soap->capath)
  {
    ...
    long handle;
    int rc;
    strcpy(pattern, soap->capath);
    strcat(pattern, "\*.pem");
    for (rc = handle = _findfirst(pattern, &fileinfo); rc != -1; rc = _findnext(handle, &fileinfo))
      if ((r = ssl_obj_load(soap->ctx, SSL_OBJ_X509_CACERT, fileinfo->name, NULL)) != SSL_OK)
        return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file in given CA path", SOAP_SSL_ERROR);
    _findclose(handle);
#else /* POSIX (probably...) */
    DIR *dir;
    struct dirent *entry;
    if (!(dir = opendir(soap->capath)))
      return soap_set_receiver_error(soap, "SSL error", "Can't open the directory specified by CA path", SOAP_SSL_ERROR);
    while ((entry = readdir(dir)))
      if (entry->d_name && strstr(entry->d_name, ".pem"))
        if ((r = ssl_obj_load(soap->ctx, SSL_OBJ_X509_CACERT, entry->d_name, NULL)) != SSL_OK)
          return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file in given CA path", SOAP_SSL_ERROR);
#endif
  }
...
{ int r;
  ...
  if (!(soap->polarssl_flags & (SOAP_SSL_POLARSSL_INIT_RSA | SOAP_SSL_POLARSSL_INIT_KEYCHAIN | SOAP_SSL_POLARSSL_INIT_CACHAIN)))
  { if (soap->ssl_flags & SOAP_SSL_RSA && soap->keyfile && soap->crtfile)
    { if ((r = x509parse_keyfile(&soap->rsa, (char*) soap->keyfile, (char*) soap->password)))
        return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read key file", SOAP_SSL_ERROR);
      soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_RSA;

      if ((r = x509parse_crtfile(&soap->keychain, (char*) soap->crtfile)))
        return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read certificate file", SOAP_SSL_ERROR);
      soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_KEYCHAIN;
    }

    if (soap->cafile)
    { if ((r = x509parse_crtfile(&soap->cachain, (char*) soap->cafile)))
        return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file", SOAP_SSL_ERROR);
      soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_CACHAIN;
    }
    else if (soap->capath)
    {
#ifdef WIN32 /* not tested */
      char pattern[80];     /* shouldn't be fixed size... */
      struct _finddata_t fileinfo;
      long handle;
      int rc;
      strcpy(pattern, soap->capath);
      strcat(pattern, "\*.pem");
      for (rc = handle = _findfirst(pattern, &fileinfo); rc != -1; rc = _findnext(handle, &fileinfo))
        if ((r = x509parse_crtfile(&soap->cachain, fileinfo->name)))
          return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file in given CA path", SOAP_SSL_ERROR);
      _findclose(handle);
#else /* POSIX (probably...) */
      DIR *dir;
      ...
      while ((entry = readdir(dir)))
        if (entry->d_name && strstr(entry->d_name, ".pem"))
          if ((r = x509parse_crtfile(&soap->cachain, entry->d_name)))
            return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "Can't read CA file in given CA path", SOAP_SSL_ERROR);
#endif
      soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_CACHAIN;
    }
    /* ssl_set_debuglvl(&soap->ssl, 4); */
  }
...
{ BIO *bio;
  ...
  fset_nonblock((SOAP_SOCKET)soap->socket);
...
{ fd_set fd;
  ...
  if (soap->ssl)
    ssl_free(soap->ssl);
  if (!(soap->ssl = ssl_server_new(soap->ctx, (SOAP_SOCKET)soap->socket)))
    return soap_set_receiver_error(soap, "SSL error", "ssl_server_new() failed in soap_ssl_accept()", SOAP_SSL_ERROR);
#ifndef WIN32
  if ((int)soap->socket >= (int)FD_SETSIZE)
    return SOAP_FD_EXCEEDED;	/* Hint: MUST increase FD_SETSIZE */
#endif
  ...
  if (soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION)
  { if (ssl_verify_cert(soap->ssl) != SSL_OK)
    { soap_closesock(soap);
      return soap_set_sender_error(soap, "SSL error", "SSL certificate presented by peer cannot be verified in soap_ssl_accept()", SOAP_SSL_ERROR);
    }
  }
...
{ fd_set fd;
  ...
  if ((soap->error = soap->fsslauth(soap)))
    return SOAP_INVALID_SOCKET; /* proper error code? */

  if (!(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL))
  { if (ssl_init(&soap->ssl))
      return soap_set_receiver_error(soap, "SSL error", "ssl_init() failed in soap_ssl_accept()", SOAP_SSL_ERROR);
    soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_SSL;
  }

  ssl_set_endpoint(&soap->ssl, SSL_IS_SERVER);
  ssl_set_authmode(&soap->ssl, soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION
  					? SSL_VERIFY_OPTIONAL
					: SSL_VERIFY_NONE);

  if(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_RSA)
    ssl_set_own_cert(&soap->ssl, &soap->keychain, &soap->rsa);
  if(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_CACHAIN)
    ssl_set_ca_chain(&soap->ssl, &soap->cachain, NULL); /* NOTE: no CN check */

  ssl_set_ciphers(&soap->ssl, ssl_default_ciphers);

  if(soap->polarssl_flags & SOAP_SSL_POLARSSL_USE_RESUMING)
  { ssl_set_session(&soap->ssl, 1, 0, &soap->session);
    ssl_set_scb(&soap->ssl, soap_ssl_get_session, soap_ssl_set_session);
  }
  else
    ssl_set_session(&soap->ssl, 0, 0, &soap->session);
  soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_SESSION;

  ssl_set_rng(&soap->ssl, havege_rand, &havege);
  ssl_set_dh_param(&soap->ssl, dummy_dhm_P, dummy_dhm_G);
  ssl_set_bio(&soap->ssl, net_recv, &soap->socket, net_send, &soap->socket);

  if ((r = ssl_handshake_server(&soap->ssl)))
    return soap_set_receiver_error(soap, soap_ssl_error(soap, r), "ssl_handshake_server() failed in soap_ssl_accept()", SOAP_SSL_ERROR);
  ...
  if (soap->ssl_flags & SOAP_SSL_REQUIRE_CLIENT_AUTHENTICATION)
  { if (ssl_get_verify_result(&soap->ssl))
    { soap_closesock(soap);
      return soap_set_sender_error(soap, "SSL error", "SSL certificate presented by peer cannot be verified in soap_ssl_accept()", SOAP_SSL_ERROR);
    }
  }
...
static int
SOAP_FMAC2
soap_ssl_get_session(ssl_context *ssl)
{ ssl_session *s_list_1st = NULL;
  ssl_session *cur = s_list_1st;
  ssl_session *prv = NULL;
  ...
  { prv = cur;
    ...
    if (ssl->timeout && t - prv->start > ssl->timeout)
      continue;
    ...
    if (memcmp(ssl->session->id, prv->id, prv->length))
      continue;
...
static int
SOAP_FMAC2
soap_ssl_set_session(ssl_context *ssl)
{ ssl_session *s_list_1st = NULL;
  ssl_session *cur = s_list_1st;
  ssl_session *prv = NULL;
  ...
  while (cur)
  { if (ssl->timeout && t - cur->start > ssl->timeout)
      break; /* expired, reuse this slot */

    if (!memcmp(ssl->session->id, cur->id, cur->length))
  ...
  if (!cur)
  { if(!(cur = (ssl_session *) malloc(sizeof(ssl_session))))
      return 1;
...
/******************************************************************************/
#endif /* WITH_OPENSSL || WITH_AXTLS || WITH_POLARSSL */
...
#elif defined(WITH_POLARSSL)
    x509_free(&soap->cachain);
    x509_free(&soap->keychain);
    rsa_free(&soap->rsa);
    ssl_free(&soap->ssl);
    soap->polarssl_flags &= ~SOAP_SSL_POLARSSL_INIT_SSL;
#endif
...
again:
  ...
  if (soap->connect_timeout)
    fset_nonblock((SOAP_SOCKET)fd);
  else
    fset_block((SOAP_SOCKET)fd);
#endif
  for (;;)
  {
#ifdef WITH_IPV6
  ...
  if (!soap_tag_cmp(endpoint, "https:*"))
  {
    ...
    soap->ssl = ssl_client_new(soap->ctx, (SOAP_SOCKET)fd, soap->session);
    if (ssl_handshake_status(soap->ssl) != SSL_OK)
    { soap->fclosesocket(soap, (SOAP_SOCKET)fd);
    ...
    { if ((r = ssl_verify_cert(soap->ssl)) != SSL_OK)
      { soap_set_sender_error(soap, "SSL error", "SSL certificate presented by peer cannot be verified in tcp_connect()", SOAP_SSL_ERROR);
        soap->fclosesocket(soap, (SOAP_SOCKET)fd);
        return SOAP_INVALID_SOCKET;
      }

      if (!(soap->ssl_flags & SOAP_SSL_SKIP_HOST_CHECK) &&
	  soap_tag_cmp(host, ssl_get_cert_dn(soap->ssl, SSL_X509_CERT_COMMON_NAME)))
    ...
    /* Set SSL sockets to non-blocking */
#ifndef WITH_LEAN
    fset_nonblock((SOAP_SOCKET)soap->master);
#endif
...
/*#if (OPENSSL_VERSION_NUMBER >= 0x0090805fL)
...
#else
              unsigned char *data;
#endif*/      const unsigned char *data; /* this is new in gSOAP 2.7e - doesn't work */
    ...
    if (!(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL))
    { if (ssl_init(&soap->ssl))
        return soap_set_receiver_error(soap, "SSL error", "ssl_init() failed in tcp_connect()", SOAP_SSL_ERROR);
      soap->polarssl_flags |= SOAP_SSL_POLARSSL_INIT_SSL;
    }
    ...
    if(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_RSA)
      ssl_set_own_cert(&soap->ssl, &soap->keychain, &soap->rsa);
    if(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_CACHAIN)
      ssl_set_ca_chain(&soap->ssl, &soap->cachain, NULL);

    ssl_set_endpoint(&soap->ssl, SSL_IS_CLIENT);
    ssl_set_authmode(&soap->ssl, soap->ssl_flags & SOAP_SSL_REQUIRE_SERVER_AUTHENTICATION
    					? SSL_VERIFY_OPTIONAL
					: SSL_VERIFY_NONE);
    ssl_set_rng(&soap->ssl, havege_rand, &havege);
    ssl_set_ciphers(&soap->ssl, ssl_default_ciphers);
    ...
    for (;;)
    { if ((r = ssl_handshake_client(&soap->ssl)))
      { if (r != POLARSSL_ERR_NET_TRY_AGAIN)
        { soap_set_sender_error(soap, soap_ssl_error(soap, r), "ssl_handshake_client() failed in tcp_connect()", SOAP_SSL_ERROR);
          soap->fclosesocket(soap, (SOAP_SOCKET)fd);
          return SOAP_INVALID_SOCKET;
        }
        if (soap->connect_timeout)
    ...
    { if (ssl_get_verify_result(&soap->ssl))
      ...
      /* PolarSSL's common name check cannot handle wildcards, so it's not used at all (see ssl_set_ca_chain) */
      if (!(soap->ssl_flags & SOAP_SSL_SKIP_HOST_CHECK))
      { x509_name *cn = NULL;

        if (soap->ssl.peer_cert)
        { for (cn = &soap->ssl.peer_cert->subject; cn; cn = cn->next)
	  { if (!memcmp(cn->oid.p, OID_CN, 3))
            { char *buf;

	      if (!(buf = strndup((char *)cn->val.p, cn->val.len)))
              { soap_set_sender_error(soap, "SSL error", "Could not allocate memory in tcp_connect()", SOAP_SSL_ERROR);
                soap->fclosesocket(soap, (SOAP_SOCKET)fd);
                return SOAP_INVALID_SOCKET;
              }

              r = soap_tag_cmp(host, buf);
              free(buf);
	      if (!r)
	        break;
	    }
...
#endif
#else
  fcntl(soap->master, F_SETFD, fcntl(soap->master, F_GETFD) | FD_CLOEXEC);
#endif
#endif
#ifndef WITH_LEAN
...
#elif defined(WITH_AXTLS) || defined(WITH_POLARSSL)
    if (soap->imode & SOAP_ENC_SSL)
    {
      if (soap_valid_socket(soap->socket)
       && FD_ISSET((SOAP_SOCKET)soap->socket, &sfd)
       && !FD_ISSET((SOAP_SOCKET)soap->socket, &rfd)) /* there's nothing like SSL_peek in axTLS/PolarSSL - maybe do a vectored read? */
        return SOAP_OK;
    }
    else
#endif
  ...
  { register int err;
    for (;;)
    {
      ...
      { struct timeval timeout;
        ...
        fset_block((SOAP_SOCKET)soap->master);
#endif
...
/* Use soap->host to store the numeric form of the remote host */
        ...
        {
	  fset_block((SOAP_SOCKET)soap->master);
	  fset_block((SOAP_SOCKET)soap->socket);
        }
...
#elif defined(WITH_AXTLS)
  if (soap->ssl)
  { if (*soap->host && (soap->session = ssl_get_session_id(soap->ssl)))
    { strcpy(soap->session_host, soap->host);
      soap->session_port = soap->port;
    }
    ssl_free(soap->ssl);
...
#elif defined(WITH_POLARSSL)
  if ((soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL) && soap->ssl.state != SSL_HS_HELLO_REQUEST)
  { int r;
    if (*soap->host)
    { strcpy(soap->session_host, soap->host);
      soap->session_port = soap->port;
    }
    if ((r = ssl_close_notify(&soap->ssl)))
      DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Couldn't close current SSL connection, ssl_close_notify() failed, ret = %d...\n", r));
  }
#endif
  if (soap_valid_socket(soap->socket) && !(soap->omode & SOAP_IO_UDP))
  { soap->fshutdownsocket(soap, (SOAP_SOCKET)soap->socket, SHUT_RDWR);
    soap->fclosesocket(soap, (SOAP_SOCKET)soap->socket);
    soap->socket = SOAP_INVALID_SOCKET;
  }
  return SOAP_OK;
...
soap_end_send(struct soap *soap)
{
  ...
  if (!soap->ssl &&
#endif
      soap_valid_socket(soap->socket) && !soap->keep_alive && !(soap->omode & SOAP_IO_UDP))
...
{ copy->mode = soap->mode;
  ...
  copy->ctx = soap->ctx;
#elif defined(WITH_POLARSSL)
  memcpy(&copy->ssl, &soap->ssl, sizeof(ssl_context));
  memcpy(&copy->session, &soap->session, sizeof(ssl_session));
  memcpy(&copy->keychain, &soap->keychain, sizeof(x509_cert));
  memcpy(&copy->cachain, &soap->cachain, sizeof(x509_cert));
  memcpy(&copy->rsa, &soap->rsa, sizeof(rsa_context));
  copy->polarssl_flags = soap->polarssl_flags;
#endif
#ifdef WITH_ZLIB
...
{ soap->state = SOAP_INIT;
  ...
  if (!ssl_init_done)
  { soap_ssl_init();
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "axTLS, version=%s\n", ssl_version()));
  }
  soap->ssl = NULL;
  soap->ctx = NULL;
  soap->session = NULL;
  ...
  if (!ssl_init_done)
  { soap_ssl_init();
    DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Using PolarSSL\n"));
  }
  /*soap->ssl = NULL;
  soap->rsa = NULL;
  soap->keychain = NULL;
  soap->cachain = NULL;*/
  memset(&soap->ssl, 0, sizeof(ssl_context));
  memset(&soap->rsa, 0, sizeof(rsa_context));
  memset(&soap->keychain, 0, sizeof(x509_cert));
  memset(&soap->cachain, 0, sizeof(x509_cert));
  memset(&soap->session, 0, sizeof(ssl_session));
  soap->polarssl_flags = 0;
#endif
...
{ struct soap_cookie *p;
  ...
  for (p = soap->cookies; p; p = p->next)
  {
    if (p->modified
#ifdef WITH_POLARSSL
     || (!p->env && !(soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL) == !p->secure)
...
{ soap_wchar c;
  ...
  *soap->endpoint = '\0';
  ...
  { soap->mode &= ~SOAP_IO;
    ...
    if (((soap->mode & SOAP_IO_CHUNK) != SOAP_IO_CHUNK && soap->length == 0) || soap_get0(soap) == (int)EOF)
    { if (soap->status == 200)
...
#endif
#ifdef WITH_COOKIES
  if (soap_putcookies(soap, host, path,
#ifdef WITH_POLARSSL
	  (soap->polarssl_flags & SOAP_SSL_POLARSSL_INIT_SSL) ? 1 : 0))
#elif defined(WITH_SSL)
	  soap->ssl != NULL))
#else
          0))
...
{ const char **c = soap_faultcode(soap);
  ...
  switch (soap->error)
  {
    ...
    case SOAP_SSL_ERROR:
      ...
      *s = "SSL error";
#else
      *s = "OpenSSL/axTLS/PolarSSL not installed: recompile with -DWITH_OPENSSL, -DWITH_AXTLS or -DWITH_POLARSSL";
#endif
      break;
...
void
SOAP_FMAC2
soap_asprint_fault(struct soap *soap, char **strp)
{ if (soap_check_state(soap))
#ifdef _GNU_SOURCE
    asprintf(strp, "Error: soap struct not initialized\n");
#else
  { static const char msg[] = "Error: soap struct not initialized\n";
    if((*strp = malloc(sizeof(msg))))
      sprintf(*strp, msg);
  }
#endif
  else if (soap->error)
...
#ifdef _GNU_SOURCE
    asprintf(strp, "%s%d fault: %s [%s] - \"%s\" - Detail: %s", soap->version ? "SOAP 1." : "Error ", soap->version ? (int)soap->version : soap->error, c, v ? v : "no subcode", s ? s : "[no reason]", d && *d ? *d : "[no detail]");
#else
    if((*strp = malloc(sizeof(char)*256)))
      snprintf(*strp, 256, "%s%d fault: %s [%s] - \"%s\" - Detail: %s", soap->version ? "SOAP 1." : "Error ", soap->version ? (int)soap->version : soap->error, c, v ? v : "no subcode", s ? s : "[no reason]", d && *d ? *d : "[no detail]");
#endif
  }
}
