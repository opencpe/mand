...
#if (defined(__GLIBC__) || defined(__GNU__)) && !defined(_GNU_SOURCE)
# define _GNU_SOURCE
#endif
...
#if defined(WITH_OPENSSL) || defined(WITH_POLARSSL)
...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
...
#elif defined(WITH_POLARSSL)
  unsigned int polarssl_flags;	/* bitmask, see below: possible bits set and their meaning */
  ...
  ~soap();
				...
				/* soap->polarssl_flags: possible bitmasks */
#define SOAP_SSL_POLARSSL_USE_RESUMING	(1 << 0)
#define SOAP_SSL_POLARSSL_INIT_SSL		(1 << 4)
#define SOAP_SSL_POLARSSL_INIT_SESSION	(1 << 5)
#define SOAP_SSL_POLARSSL_INIT_RSA		(1 << 6)
#define SOAP_SSL_POLARSSL_INIT_KEYCHAIN	(1 << 7)
#define SOAP_SSL_POLARSSL_INIT_CACHAIN	(1 << 8)
...
#elif defined(WITH_POLARSSL)
# define soap_random soap_rand(&havege)
SOAP_FMAC1 int SOAP_FMAC2 soap_rand(havege_state *hs);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_server_context(struct soap*, unsigned short, const char*, const char*, const char*, const char*, const char*, const char*, const char*, const void*);
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_client_context(struct soap*, unsigned short, const char*, const char*, const char*, const char*, const char*, const char*);
...
SOAP_FMAC1 void SOAP_FMAC2 soap_asprint_fault(struct soap *soap, char **strp);
